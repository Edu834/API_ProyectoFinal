...
('P001', 1, null, 'Classic Suit', 'Traje clásico de corte recto, adecuado para ocasiones formales', 'BrandX', 'M'),
('P002', 1, null, 'Slim Fit Suit', 'Traje ajustado para un look moderno', 'BrandY', 'M'),
('P003', 1, null, 'Formal Blazer', 'Blazer formal de corte recto, ideal para eventos', 'BrandZ', 'M'),
...
('P007', 2, null, 'Leather Jacket', 'Chaqueta de cuero, ideal para la temporada de otoño', 'BrandD', 'M'),
('P008', 2, null, 'Blazer', 'Blazer formal con corte ajustado', 'BrandE', 'M'),
...
('P021', 6, null, 'Body Top', 'Top de cuerpo ajustado, ideal para combinar con faldas', 'BrandR', 'H'),
('P022', 6, null, 'Crop Top', 'Top corto, muy de moda', 'BrandS', 'H'),
('P023', 6, null, 'Blouse', 'Blusa elegante para ocasiones formales', 'BrandT', 'H'),
('P024', 6, null, 'Tank Top', 'Top sin mangas, ideal para el verano', 'BrandU', 'H'),
...
('P027', 7, null, 'Chinos', 'Pantalones chinos, versátiles y cómodos', 'BrandX', 'M'),
...
('P031', 8, null, 'Cardigan', 'Cárdigan largo, cómodo para el otoño', 'BrandB', 'M'),
('P032', 8, null, 'Turtleneck Sweater', 'Suéter de cuello alto, ideal para el invierno', 'BrandC', 'M'),
...
('P035', 9, null, 'Zip-up Sweatshirt', 'Sudadera con cremallera, fácil de poner y quitar', 'BrandF', 'H'),
